...
#ifndef CLIPPY_SWIFT_H
#define CLIPPY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Clippy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC6Clippy14KeyCaptureView")
...
SWIFT_CLASS("_TtC6Clippy14ScreenRecorder")
...
@class SCStream;
@interface ScreenRecorder (SWIFT_EXTENSION(Clippy)) <SCStreamDelegate>
- (void)stream:(SCStream * _Nonnull)stream didStopWithError:(NSError * _Nonnull)error;
@end

@interface ScreenRecorder (SWIFT_EXTENSION(Clippy)) <SCStreamOutput>
- (void)stream:(SCStream * _Nonnull)stream didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer ofType:(SCStreamOutputType)type;
@end

SWIFT_CLASS("_TtC6Clippy20VoiceCommandListener")
@interface VoiceCommandListener : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
